...
class SpendingPatternsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SpendingPatternsScreen> createState() => _SpendingPatternsScreenState();
}

class _SpendingPatternsScreenState extends ConsumerState<SpendingPatternsScreen> {
        ...
        child: Column(
          ...
          children: [
            KuberPageHeader(
              ...
              description: 'When and where your money goes',
            ),
            Padding(
