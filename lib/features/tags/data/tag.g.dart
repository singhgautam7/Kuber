...
extension TagQueryFilter on QueryBuilder<Tag, Tag, QFilterCondition> {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> isEnabledEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
...
extension TagQuerySortBy on QueryBuilder<Tag, Tag, QSortBy> {
  ...
  QueryBuilder<Tag, Tag, QAfterSortBy> sortByIsEnabled() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEnabled', Sort.asc);
    });
  }

  QueryBuilder<Tag, Tag, QAfterSortBy> sortByIsEnabledDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TagQuerySortThenBy on QueryBuilder<Tag, Tag, QSortThenBy> {
  ...
  QueryBuilder<Tag, Tag, QAfterSortBy> thenByIsEnabled() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEnabled', Sort.asc);
    });
  }

  QueryBuilder<Tag, Tag, QAfterSortBy> thenByIsEnabledDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEnabled', Sort.desc);
    });
  }
...
extension TagQueryWhereDistinct on QueryBuilder<Tag, Tag, QDistinct> {
  ...
  QueryBuilder<Tag, Tag, QDistinct> distinctByIsEnabled() {
    return QueryBuilder.apply(this, (query) {
...
extension TagQueryProperty on QueryBuilder<Tag, Tag, QQueryProperty> {
  ...
  QueryBuilder<Tag, bool, QQueryOperations> isEnabledProperty() {
    return QueryBuilder.apply(this, (query) {
