...
class InsightEngine {
  ...
  static (IconData, InsightAccent, String) _iconForType(
    InsightType type,
    bool isPositive,
  ) {
    ...
    return switch (type) {
      ...
      InsightType.categoryTrend =>
        isPositive
            ? (
                ...
                InsightAccent.income,
                l10n.insightLabelCategoryTrend,
              )
            : (
                Icons.trending_up_rounded,
                InsightAccent.expense,
                l10n.insightLabelCategoryTrend,
              ),
      ...
      InsightType.savingsTrend =>
        isPositive
            ? (Icons.savings_outlined, InsightAccent.income, l10n.insightLabelSavings)
            : (Icons.warning_amber_rounded, InsightAccent.warning, l10n.insightLabelSavings),
